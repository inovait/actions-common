...
function parseCommits(commits) {
    ...
    return commits.map(rawCommit => {
        ...
        if (match != null) {
            return new ParsedCommit(rawCommit, match[6].trim(), match[5], match[3], match[2], rawCommit.body().includes('BREAKING'));
        }
        else {
        ...
        try {
            ...
            while (true) {
                try {
                    ...
                    const commit = yield repo.getCommit(next);
            ...
            const changelog = (0, generator_1.generateChangelog)(gatheredCommits, {
                gitCommitUrlPrefix,
                jiraUrl
            });
            if (targetFile !== '') {
...
var fp = __nccwpck_require__(4542);
...
// Set version.
exports.version = __nccwpck_require__(296).version;
...
var fse = __nccwpck_require__(5630);
var fp = __nccwpck_require__(4542);
var NodeGit = __nccwpck_require__(2596);
...
module.exports = require(__nccwpck_require__.ab + "build/Release/nodegit.node")
