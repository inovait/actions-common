...
const commit_parsing_1 = __nccwpck_require__(928);
...
const generator_1 = __nccwpck_require__(953);
const fs = __importStar(__nccwpck_require__(292));
const commit_gathering_1 = __nccwpck_require__(726);
function main() {
...
const child_process = __importStar(__nccwpck_require__(718));
