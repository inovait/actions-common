...
```yaml
- uses: inovait/actions-common/gradle-setup@da9a92bef70418c0a9cdd17eafab499fc42428cd #v17
  with:
    java-version: 17
```
...
```yaml
- uses: inovait/actions-common/android-setup@da9a92bef70418c0a9cdd17eafab499fc42428cd #v17
  with:
    java-version: 17
```
