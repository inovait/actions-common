...
```yaml
- uses: inovait/actions-common/gradle-setup@bc6e8307a6a58e5f9b49e1d288bf75c170ef242b #v18
  with:
    java-version: 17
```
...
```yaml
- uses: inovait/actions-common/android-setup@bc6e8307a6a58e5f9b49e1d288bf75c170ef242b #v18
  with:
    java-version: 17
```
